...
- Elman/Jordan network (elman, jordan)
- Autoassociative Networks (assoz)
- BackpropThroughTime
- BackpropMomentum
...
trainInputs <- normalizeData(trainInputs, type = "norm") #also type = "0_1" or "center"
# # test inputs normalized using training data normalization values
...
# model_glm <- glm(output~feat1, data = trainData, family = gaussian())
